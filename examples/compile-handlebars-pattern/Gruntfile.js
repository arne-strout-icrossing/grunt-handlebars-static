...
module.exports = function(grunt) {
  ...
  grunt.loadNpmTasks('handlebars-static');
  grunt.loadNpmTasks('grunt-sass');
  grunt.loadNpmTasks('grunt-clean');
  grunt.loadNpmTasks('grunt-contrib-requirejs');
  // Default task.
  grunt.registerTask('default','clean lint requirejs handlebars-static sass');
  grunt.registerTask('watch','clean lint requirejs handlebars-static sass watch');
};